      ...
      <ol className="list-reset flex border-b">
        {labels.map((lbl) => (
          <li
            className={
              activeTab === lbl
                ? 'bg-white inline-block border-b-2 py-2 px-4 hover:text-blue-darker font-semibold hover:text-purple-500 focus:outline-none'
                : 'bg-white inline-block rounded-t py-2 px-4 hover:text-purple-500 focus:outline-none'
            }
